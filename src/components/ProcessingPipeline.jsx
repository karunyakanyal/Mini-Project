const steps = [
  ...
  ['Classification', 'Use the similarity result to determine the final class.', 'M9 3h6l6 6v6l-6 6H9l-6-6V9l6-6 M8 12l3 3 5-6'],
]
...
export default function ProcessingPipeline() {
  return <section className="pipeline-page" id="how-it-works" aria-labelledby="pipeline-heading">
    <div className="section-heading"><div><p className="eyebrow">How QuerySense Works</p><h1 id="pipeline-heading">How the Comparison Works</h1></div><span className="small-tag">Planned NLP Pipeline</span></div>
